...
# Famílias ArUco (AprilTag) disponíveis no OpenCV
FAMILIES = {
...
def gerar_aruco(tag_id: int, family: str = "tag36h11", size: int = 400,
                output_dir: str | None = None, quiet_zone: bool = True) -> Path:
    """Gera uma imagem PNG de um marcador ArUco válido usando cv2.aruco.
    ...
    filename = dest / f"tag{tag_id}.png"
