...
class Rta(GraphMachine):
    ...
    def __init__(self, model) -> None:
        ...
        transitions = [
            ...
            {'trigger': 'return_to_start_to_move_to_r_o_i', 'source': 'return_to_start', 'dest': 'move_to_r_o_i', 'conditions': ['always_true'], 'after': ['set_markers_found_false', 'set_aligned_false', 'set_touch_ok_false', 'set_swipe_executed_false', 'set_final_result_none', 'set_marker_index_zero']},
            ...
            {'trigger': 'reset_markers_to_move_to_r_o_i', 'source': 'reset_markers', 'dest': 'move_to_r_o_i'},
