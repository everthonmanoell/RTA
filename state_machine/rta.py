...
class Rta(GraphMachine):
    ...
    def __init__(self, model) -> None:
        ...
        transitions = [
            ...
            {'trigger': 'detect_markers_to_align_with_markers', 'source': 'detect_markers', 'dest': 'align_with_markers', 'conditions': ['camera_on', 'markers_found'], 'after': ['set_marker_index_zero', 'set_align_with_markers_attempt_zero']},
