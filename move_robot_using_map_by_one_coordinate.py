...
from transform_coordinates import TransformCoordinates
...
def execute_keyboard() -> int:
    ...
    relative_positions = {1: [7.6, 69.5], 2: [16.9, 69.5], 3: [26.3, 69.5], 4: [35.6, 69.5], 5: [45.1, 69.5], 6: [54.5, 69.5], 7: [64.0, 69.5], 8: [73.4, 69.5], 9: [82.9, 69.5], 0: [92.3, 69.5],
    ...
    transform = TransformCoordinates(cal_map.useful_rect_px)
    keys_dict = transform.get_dict_key_coordinates(relative_positions)
